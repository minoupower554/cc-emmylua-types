...
---@field sendFormattedMessage fun(message: string, prefix: string?, brackets: string?, bracketColor: string?, range: number?, utf8Support: boolean?): true|nil, string Sends a JSON formatted message to the global chat
---@field sendFormattedMessageToPlayer fun(message: string, username: string, prefix: string?, brackets: string?, bracketColor: string?, range: number?, utf8Support: boolean?): true|nil, string Sends a JSON formatted message to the specified user
